                ...
                @foreach($roles as $role)
                    ...
                    <div class="col-md-4 p-1 thumbnail roles_card_all">
                        <div class="card card-dark-blue">
                            ...
                            <div class="roles_card roles_down_arrow">
                                ...
                                <button type="button" class="btn bg-transparent remove_permission_for_role col-md-" data-bs-toggle="modal" data-bs-target="#removePermissionsForRole-{{$role->id}}" style="color:white;margin-top:-20px">Remove Permissions<i class="fa-solid fa-circle-plus p-2 fa-3x"><input type="hidden" value="{{$role->id}}" name="roles_card_id_remove"></i></button>

                                <button type="button" class="btn bg-transparent add_permission_for_role col-md-" data-bs-toggle="modal" data-bs-target="#addPermissionsForRole-{{$role->id}}" style="color:white;margin-top:-20px">Add Permissions<i class="fa-solid fa-circle-plus p-2 fa-3x"><input type="hidden" value="{{$role->id}}" name="roles_card_id_add"></i></button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="removePermissionsForRole-{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="removePermissionsForRole-{{$role->id}}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="removePermissionsForRole-{{$role->id}}">Remove Permission</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <!-- Modal to add permission for role -->
                    <div class="modal fade" id="addPermissionsForRole-{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="addPermissionsForRole-{{$role->id}}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addPermissionsForRole-{{$role->id}}">Add Permission</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
